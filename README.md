...
### 1.1 Обща информация
- **Име:** Personal Website - Cybersecurity Tools & Resources Hub
- **Версия:** 1.0
- **Автор:** Ioannis Triantos
- **Цел:** Уебсайт с инструменти за сигурност за разработчици и специалисти по киберсигурност
